...
# b'\x00\x00\x16\x03 \x00C\x01\x00\x00: BBBBB\x15                    \xff\xff\xff\xff\xff\xff \x05     \x00\x02\x00\x02\x03  \x00\x00\x08\x00\x10\x00\x04\x00\x02\x01\x00\xff\xff\xff\xff\xff'

# Minimized distance to valid input is:  396
# Original distance to valid input is:  410
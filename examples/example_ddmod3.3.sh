...
# b"\x16\x07;:;\xe1nono!\x16';-z:-:'\x8c)\xb7*;G\x8e*\x97;():!)\x86\xc2%\xa8'(\xd7(:(\x1b*\xe1nono!\x16';-z:-:'\x8c\xb7*;G\x8e*\x97;(\x8c;Y3(&\xaf\xaa(J\r\xa2:%::!;:\x82D!):!)\x86\xc2%!\xa8'*\xd5@n(:\xa7z'\x14rU\xb7*\xa8''\xb7*\xa8(\xb3"

# Minimized distance to valid input is:  1
# Original distance to valid input is:  126